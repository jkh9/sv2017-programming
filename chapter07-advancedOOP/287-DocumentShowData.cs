...
Class Document (10) + Book + ShowData

Create a new version (10) in which the class Document will contain a method 
ShowData which will display the message "Author=a, Title=t". In the class Book, 
the ShowData will display also ", Cover=P". 
