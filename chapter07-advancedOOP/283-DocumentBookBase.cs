...
Class Document (7) + Book + base

Create a new version (7) in which you will add a new class Book, inheriting 
from Document. This new class will contain one attribute, "cover", a "char" 
("H" for Hardcover, "P" for Paperback).

Version 2: Use "base" to extended the constructor from the superclass
*/
